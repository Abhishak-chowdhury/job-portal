                ...
                <div class="card border-0 shadow mb-4 p-3">
                    <div class="card-body card-form">
                        ...
                        <div class="table-responsive">
                            @if($jobs->isEmpty())
                            <h1 style="color:red;font-size:25px">No Data Is Available. Please Make Post</h1>
                            @else
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr class="active">
                                        <td>
                                            ...
                                            <div class="info1">{{$job->jobNature->name}} . {{$job->location}}</div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="{{route('update.post',$job->id)}}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
                                                    <li><a class="dropdown-item" href="{{route('delete.post',$job->id)}}"><i class="fa fa-trash" aria-hidden="true"></i> Remove</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
