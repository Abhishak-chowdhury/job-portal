                ...
                <div class="card border-0 shadow mb-4 p-3">
                    <div class="card-body card-form">
                        ...
                        <div class="table-responsive">
                            @if($jobs->isEmpty())
                            <h1 style="color:red;font-size:25px">No Data Is Available. Please apply on job</h1>
                            @else
                            <table class="table ">
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="{{route('delete.jobapply',$jb->id)}}"> <i class="fa fa-eye" aria-hidden="true"></i>Remove</a></li>
