<div class="col-lg-3">
                <div class="card border-0 shadow mb-4 p-3">
                    <div class="s-body text-center mt-3">
                        @if(Auth::user()->image)
                        <img src="{{asset('user_profile/'.$user->image)}}" alt="avatar"  class="rounded-circle img-fluid" style="width: 150px;">
                        @else
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush ">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <a href="{{route('posts')}}">Post a Job</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <a href="{{route('myposts')}}">My Jobs</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <a href="{{route('account.jobapply')}}">Jobs Applied</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
