    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="{{route('update.post.process',$job->id)}}" method="post">
                    @csrf
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <option value="{{$job_roll->id}}" @if($job->job_nature_id==$job_roll->id) selected @endif>{{$job_roll->name}}</option>
                                 @endforeach   
                                </select>
                                @error('job_roll')
                                <p style="color:red;font-size:13px;">{{ $message }}</p>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="trumbowyg-demo" name="description" id="description" cols="5" rows="5" placeholder="Description">{{$job->description}}</textarea>
                            @error('description')
                                <p style="color:red;font-size:13px;">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-4">
                                ...
                                <option value="1" @if($job->exprience == '1') selected @endif >1 year</option>
                                <option value="2" @if($job->exprience == '2') selected @endif>2 year</option>
                                <option value="3" @if($job->exprience == '3') selected @endif>3 year</option>
                                <option value="4" @if($job->exprience == '4') selected @endif>4 year</option>
                                <option value="5" @if($job->exprience == '5') selected @endif>5 year</option>
                                <option value="6" @if($job->exprience == '6') selected @endif>6 year</option>
                                <option value="7" @if($job->exprience == '7') selected @endif>7 year</option>
                                <option value="8" @if($job->exprience == '8') selected @endif>8 year</option>

                                <option value="9" @if($job->exprience == '9') selected @endif>9 year</option>
                                <option value="10" @if($job->exprience == '10') selected @endif>10 year</option>
                                <option value="10+" @if($job->exprience == '10+') selected @endif>10+ year</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="trumbowyg-demo" name="responsibility" id="responsibility" cols="5" rows="5" placeholder="Responsibility">{{$job->responsibility}}</textarea>
                        </div>
                        <div class="mb-4">
                            <label for="qualifications" class="mb-2">Qualifications</label>
                            <textarea class="trumbowyg-demo" name="qualifications" id="qualifications" cols="5" rows="5" placeholder="Qualifications">{{$job->qualifications}}</textarea>
                        </div>
